...
pdf_wm_upper_right = {"title": "JOIN NOW", "url": "https://t.me/Toxic_Official_1"}   # 30% opacity, 45° rotation (original)
...
pdf_wm_down_middle = {"title": "/d", "url": "/d"}   # 95% opacity, 0° rotation
# ─────────────────────────────────────────────────────────────────────────────
